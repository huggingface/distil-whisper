...
6. To confirm that you have a working environment, you can run the following code cell to stream one sample of data from the LibriSpeech dataset, and check that you can perform a forward pass of the "tiny" Whisper model:
